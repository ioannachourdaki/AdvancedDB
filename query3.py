...
# Imports for Query3
from pyspark.sql.functions import year, count, desc, countDistinct, regexp_replace
...
# We read 'Estimated Median Income' as string bc there are the '$', ',' characters, we remove them and we convert the type to integer,
# bc we will use this colummn in orderBy later
...
# We chech if there are multiple zip codes for a pair of LAT, LON values -> there are non
